 ...
 */
class Links_List_Table extends Custom_WP_List_Table
{
  ...
  {
    $columns = [
      'filename'     => __('Dispatched File', 'wp-dispatcher'),
      'expires'  => __('Expires in', 'wp-dispatcher'),
  ...
  {
    _e('No links available.', 'wp_dispatcher');
  }
}
